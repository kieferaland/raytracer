...
class vec3
{
    public:
		  ...
		  inline double x () const {return i;}
		  inline double y () const {return j;}
		  inline double z () const {return k;}
		  inline double r () const {return i;}
		  inline double g () const {return j;}
		  inline double b () const {return k;}
